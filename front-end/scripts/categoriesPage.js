    ...
    $(function() {
        ...
        var albumContainerTemplate =
            ...
            '<div class="row col-md-12 album-container">' +
                ...
                '<div><button class="delete-btn btn-small pull-right btn-danger">X</button></div>' +
                '</div>' +
        ...
        function drawAlbums(data) {
            ...
            $(data).each(function(_, album) {
                ...
                $currAlbum.find('.delete-btn').on('click', deleteAlbumClicked);
        ...
        function deleteAlbumClicked() {
            var currAlbum = $(this).parents('.album-container').data('albumInformation');
            console.log(currAlbum);
            service.deleteAlbum(currAlbum.Id, [getAlbums, successDelete], error);
        }

        function successDelete() {
            ohSnap('Delete successfull.', 'green');
        }
